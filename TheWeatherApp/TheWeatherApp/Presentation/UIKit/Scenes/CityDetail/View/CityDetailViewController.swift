...
final class CityDetailViewController: UIViewController, Storyboardable {
    ...
    private(set) var coordinator: CityDetailCoordinator?
    ...
    static func makeSelf(city: City, coordinator: CityDetailCoordinator) -> CityDetailViewController {
        let cityDetailViewController = CityDetailViewController.create()
        cityDetailViewController.city = city
        cityDetailViewController.coordinator = coordinator
